...
class ErrorHandler:
    ...
    def handle_exception(
        exception: Exception, method: str = "unknown"
    ) -> Dict[str, Any]:
        """
        ...
        error_info = {
            ...
            "data": {"method": method, "exception_type": type(exception).__name__},
        }
    ...
    def create_error_response(
        error_code: int, message: str, data: Optional[Dict] = None
    ) -> Dict[str, Any]:
        """
        ...
        """
        response = {"jsonrpc": "2.0", "error": {"code": error_code, "message": message}}
